...
struct HTTP_Request {
  ...
  inline HTTP_Request(string request); // Constructor
};
...
struct HTTP_Response {
  ...
  inline string get_string(); // Returns the string representation of the HTTP Response
};

inline HTTP_Response *handle_request(string request);
